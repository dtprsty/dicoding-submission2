...
import com.example.prasetyo.footballmatchschedule.adapter.PastEventAdapter
 ...
 *
 */
class PreviousMatchFragment : Fragment(), AnkoLogger {
    ...
    private lateinit var mainUI: PreviousMatchFragmentUI<PreviousMatchFragment>
    ...
    companion object {
        fun newInstance(): PreviousMatchFragment {
            var fragmentHome = PreviousMatchFragment()
            var args = Bundle()
    ...
    private fun initRecyclerView() {
        ...
        itemList.clear()
        adapter = PastEventAdapter(itemList)
    ...
    fun getTeams() {
        ...
        AndroidNetworking.get(TheSportDBApi.lastEvents())
                .setTag(this)
                    ...
                    override fun onResponse(response: JSONObject) {
                        ...
                        try {
                            ...
                            for (i in 0 until array.length()) {
                                ...
                                events.homeScore= jsonObject.getInt("intHomeScore")
                                events.awayScore = jsonObject.getInt("intAwayScore")
    ...
    class PreviousMatchFragmentUI <T>: AnkoComponent<PreviousMatchFragment> {
